...
Administrator.create!([email: 'his9726@gmail.com', password: '11111111', password_confirmation: '11111111', name: 'root'])
Administrator.create!([email: 't0444564@gmail.com', password: '11111111', password_confirmation: '11111111', name: 'root'])
Administrator.create!([email: 'fordayever@gmail.com', password: '11111111', password_confirmation: '11111111', name: 'root'])
Administrator.create!([email: 'minruyu@gmail.com', password: '11111111', password_confirmation: '11111111', name: 'root'])
Administrator.create!([email: 'sophiamag@gmail.com', password: '11111111', password_confirmation: '11111111', name: 'root'])
Administrator.create!([email: 'boweichen0515@gmail.com', password: '11111111', password_confirmation: '11111111', name: 'root'])
Administrator.create!([email: 'Litigatoryang@gmail.com', password: '11111111', password_confirmation: '11111111', name: 'root'])
Administrator.create!([email: 'shindrgon@gmail.com', password: '11111111', password_confirmation: '11111111', name: 'root'])
Administrator.create!([email: 'j84255801912@gmail.com', password: '11111111', password_confirmation: '11111111', name: 'root'])
Administrator.create!([email: 'pangyenchin@gmail.com', password: '11111111', password_confirmation: '11111111', name: 'root'])
Administrator.create!([email: 'wairawa@gmail.com', password: '11111111', password_confirmation: '11111111', name: 'root'])
Administrator.create!([email: 'fall80926@gmail.com', password: '11111111', password_confirmation: '11111111', name: 'root'])
Administrator.create!([email: 'vuvudk@gmail.com', password: '11111111', password_confirmation: '11111111', name: 'root'])
Administrator.create!([email: 'daisyleeak@gmail.com', password: '11111111', password_confirmation: '11111111', name: 'root'])
